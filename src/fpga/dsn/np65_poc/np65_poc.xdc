...
set_multicycle_path 2 -setup -from [get_clocks clk_x2] -to [get_clocks clk_x2] -through [get_nets -hierarchical cache_z_d[*]]
set_multicycle_path 1 -hold -from [get_clocks clk_x2] -to [get_clocks clk_x2] -through [get_nets -hierarchical cache_z_d[*]]
set_multicycle_path 2 -setup -from [get_clocks clk_x2] -to [get_clocks clk_x2] -through [get_nets -hierarchical cache_s_d[*]]
set_multicycle_path 1 -hold -from [get_clocks clk_x2] -to [get_clocks clk_x2] -through [get_nets -hierarchical cache_s_d[*]]
